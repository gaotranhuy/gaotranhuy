  ...
  return (
    ...
    <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 w-full overflow-hidden">
          ...
          <div className="flex items-center gap-2 overflow-x-auto py-1 max-w-full scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {gallery.map((img, i) => (
              <button
                ...
                className={`relative aspect-square h-16 w-16 sm:h-20 sm:w-20 shrink-0 overflow-hidden rounded-xl border-2 bg-card transition-all duration-300 ${
                  activeImage === i
      ...
      <div className="flex flex-col w-full min-w-0">
        ...
        {/* Trust badges */}
        <div className="mt-6 grid grid-cols-3 gap-2 border-t border-muted pt-5">
