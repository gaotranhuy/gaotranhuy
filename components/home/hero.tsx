...
export function Hero({ totalProducts }: HeroProps) {
  ...
  const heroImage =
    'https://res.cloudinary.com/f9krxetg/image/upload/v1784212095/IMG_5727_1_kcnq4n.avif';
      ...
      <div className="container-page relative grid items-center gap-10 py-12 sm:py-16 lg:grid-cols-2 lg:gap-8 lg:py-24">
        <div className="flex flex-col items-start gap-6">
          ...
          <div className="flex flex-row flex-wrap items-center gap-3">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="h-12 rounded-xl border-input bg-background text-base font-normal text-foreground transition-all hover:bg-accent hover:text-accent-foreground"
            >
              <a
                href={grabMartUrl}
                target="_blank"
          ...
          <div className="mt-4 grid w-full grid-cols-3 gap-6 border-t pt-6">
            <div>
        ...
        <div className="relative">
          <div className="relative aspect-square overflow-hidden rounded-3xl border bg-muted shadow-2xl">
            <Image
              src={optimizeCloudinaryUrl(heroImage, 'banner')}
          ...
          <div className="absolute -left-4 top-8 flex items-center gap-2 rounded-2xl border bg-background/95 p-3 shadow-lg sm:-left-8 sm:backdrop-blur animate-float">
          ...
          <div
            className="absolute -right-4 bottom-12 flex items-center gap-2 rounded-2xl border bg-background/95 p-3 shadow-lg sm:-right-8 sm:backdrop-blur animate-float"
          ...
          <div
            className="absolute right-8 top-4 flex items-center gap-2 rounded-2xl border bg-background/95 p-3 shadow-lg sm:backdrop-blur animate-float"
